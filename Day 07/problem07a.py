...
# hand type (from high card to five of a kind). Then
# rank order based on card value for hands of the
# same type.
import time
...
def getType(hand):
   ...
   # All five cards must be the same.
   elif len(hand_set) == 1:
